...
set PATH_SET=%MSYS64_PATH%;%JAVA_PATH%;%MISC1_PATH%;%UTILS_PATH%;%PATH_MIN%;%PS_PATH%;%AWSCLI_PATH%;%GIT_PATH%;%NODEJS_PATH%;%SQLSVR_PATH%;%DOTNET_PATH%;%STRAWBERRY_PATH%;%NV_PHYSX_PATH%;%CONDA_PATH%;%CHOCO_PATH%;%JDK_PATH%;%NPM_PATH%;%CMAKE_PATH%
